...
public class HelloWorkItemHandler implements WorkItemHandler {
    ...
    private static int numReqMsgs = 10;
	...
	// kie server user
	private static String servUser = "yoda";
	private static String servPass = "usetheforce123@";
	
	// workbench user
	private static String wbUser = "yoda";
	private static String wbPass = "usetheforce123@";
    ...
    public void executeWorkItem(WorkItem item,
		...
		logger.info("**** Inside TestJMSWorkItemHandler, suspending.... ****");
			...
			try {
				...
				Session session = connection.createQueueSession(false, ack);
				...
				String containerId = "org.kie.server.testing:jms-wih-project:1.0.0.Final";
						//"org.kie.testing:new-jms-test:1.0.0-SNAPSHOT";
